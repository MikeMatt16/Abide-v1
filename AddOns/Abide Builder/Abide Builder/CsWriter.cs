...
namespace Abide.Builder
{
    internal class CsWriter : IDisposable
    {
        ...
        private FileStream CsFileStream = null;
        ...
        {
            //Open
            CsFileStream = new FileStream(fileName, FileMode.Create);
            Writer = new StreamWriter(CsFileStream, new UTF8Encoding());
        }
        public void Close()
        {
            //Close
