...
{
    /// <summary>
    /// Represents an editor for Halo 2 Beta Map Files using the <see cref="MapFile"/> class.
    /// </summary>
    public partial class Editor : Form, IHost
    {
        ...
        private Editor()
        {
            ...
            //Prepare Container
            container = new HaloAddOnContainer<MapFile, IndexEntry, Xbox>(MapVersion.Halo2b);
        ...
        private void saveToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            if (!File.Exists(filename) || string.IsNullOrEmpty(filename))
                ...
                {
                    //Setup
                    saveDlg.Filter = "Halo 2 Beta Maps (*map)|*.map";
        ...
        private class IndexEntryWrapper
        {
            ...
            /// <summary>
            /// Gets and returns the translated address of the tag data.
            /// </summary>
            [Category("Tag Properties"), Description("The translated address of the Tag data.")]
            public long TranslatedAddress
            {
                get { return offset - ((FixedMemoryMappedStream)tagData).MemoryAddress; }
            }
            /// <summary>
