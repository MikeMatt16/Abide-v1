...
namespace Abide.AddOnApi
{
    ...
    public class ContextMenuItem<TMap, TEntry, TXbox> : IContextMenuItem<TMap, TEntry, TXbox>
    {
        /// <summary>
        ...
        Image IContextMenuItem<TMap, TEntry, TXbox>.Icon
        {
            get { return icon; }
        }
        ...
        void IContextMenuItem<TMap, TEntry, TXbox>.OnClick()
        {
            //Create Args
            var e = new EventArgs();
