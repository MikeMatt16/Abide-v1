...
namespace YeloDebug
{
	...
	public partial class Xbox
	{
		...
		/// Xbox connection.
		/// </summary>
		public Xbox(string AppStartupPath)
        {
            // load settings file
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load(AppStartupPath + @"\YeloDebugSettings.xml");
        ...
        public List<DebugConnection> QueryXboxConnections()
        {
            ...
            while (elapse.TotalMilliseconds < 25);
        ...
        /// <summary>
        /// If Connect() does not work for you when specifying an ip, try this...
        /// </summary>
        /// <param name="ip"></param>
        ...
        private void GetXboxInformation()
        {
            ...
            // TODO: get xbdm base address
            // warn if it isnt 0xB0000000
        ...
        */
		...
		public uint CallAddressEx(uint address, CPUContext context, bool returnValue, params object[] pushArgs)
		{
            ...
            {            
                ...
                call.Write(Util.ObjectToByteArray(pushArgs[i]));    // bugfix: improper conversion of floating point values
            }
			...
			if (context != null)
			{
				...
				if (context.Eax != null)
				{
                    ...
                    call.Write(Util.ObjectToByteArray(context.Eax));
				}
				if (context.Ebx != null)
				{
					call.Write((byte)0xBB); //mov ebx
                    call.Write(Util.ObjectToByteArray(context.Ebx));
				}
				if (context.Ecx != null)
				{
					call.Write((byte)0xB9); //mov ecx
                    call.Write(Util.ObjectToByteArray(context.Ecx));
				}
				if (context.Edx != null)
				{
					call.Write((byte)0xBA); //mov edx
                    call.Write(Util.ObjectToByteArray(context.Edx));
				}
				if (context.Esi != null)
				{
					call.Write((byte)0xBE); //mov esi
                    call.Write(Util.ObjectToByteArray(context.Esi));
				}
				if (context.Edi != null)
				{
					call.Write((byte)0xBF); //mov edi
                    call.Write(Util.ObjectToByteArray(context.Edi));
				}
				if (context.Esp != null)
				{
					call.Write((byte)0xBC); //mov esp
                    call.Write(Util.ObjectToByteArray(context.Esp));
				}
				if (context.Ebp != null)
				{
					call.Write((byte)0xBD); //mov ebp
                    call.Write(Util.ObjectToByteArray(context.Ebp));
				}
