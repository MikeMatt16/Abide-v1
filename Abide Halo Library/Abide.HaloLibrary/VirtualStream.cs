...
namespace Abide.HaloLibrary.IO
{
    ...
    public class VirtualStream : Stream
    {
        ...
        {
            get { return BaseAddress + memoryStream.Position; }
            set { memoryStream.Position = value - BaseAddress; }
        }
        /// <summary>
        /// Gets a value indicating whether the stream supports reading.
        /// </summary>
        public override bool CanRead => memoryStream?.CanRead ?? false;
        /// <summary>
        /// Gets a value indicating whether the stream supports writing.
        /// </summary>
        public override bool CanWrite => memoryStream?.CanWrite ?? false;
        /// <summary>
        /// Gets a value indicating whether the stream supports seeking.
        /// </summary>
        public override bool CanSeek => memoryStream?.CanSeek ?? false;
        /// <summary>
        /// Gets the length of the stream in bytes.
        /// </summary>
        public override long Length => memoryStream?.Length ?? 0;

        /// <summary>
        /// Gets and returns the virtual memory address of the stream.
        /// </summary>
        [Obsolete("Use BaseAddress instead.")]
        public long MemoryAddress => BaseAddress;
        /// <summary>
        /// Gets and returns the starting virtual address of the stream.
        /// </summary>
        ...
        {
            memoryStream = new MemoryStream(buffer ?? new byte[0]);
            BaseAddress = memoryAddress;
        }
        /// <summary>
        ...
        public override long Seek(long offset, SeekOrigin origin)
        {
            ...
            switch (origin)
            {
                case SeekOrigin.Current: return BaseAddress + memoryStream.Seek(offset, SeekOrigin.Current);
                case SeekOrigin.Begin: return BaseAddress + memoryStream.Seek(offset - BaseAddress, SeekOrigin.Begin);
                case SeekOrigin.End: return BaseAddress + memoryStream.Seek(offset, SeekOrigin.End);
            }
        ...
        {
            return $"Position: {memoryStream.Position + BaseAddress} ({memoryStream.Position}) Size: {memoryStream.Capacity}";
        }
        /// <summary>
        ...
        /// <summary>
        /// Releases all unmanaged resources used by the <see cref="VirtualStream"/> instance.
        /// </summary>
        ~VirtualStream()
        {
            Dispose(false);
        ...
        {
            data = memoryStream?.ToArray() ?? new byte[0];
        }
