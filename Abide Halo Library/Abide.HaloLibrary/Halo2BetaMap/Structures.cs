...
{
    /// <summary>
    /// Represents a Halo 2 Beta map file header.
    /// </summary>
    ...
    public struct Header
    {
        ...
        [FieldOffset(372)]
        private StrangeBlock strangeBlock;
        [FieldOffset(408)]
...
#pragma warning disable 0169, 0649
        private struct MapInfoBlock
        {
            public uint mapType;
            private uint unknown0, unknown1, unknown2;
        }
        private struct StrangeBlock
        {
...
#pragma warning restore 0169, 0649
    ...
    /// <summary>
    /// Represents a Halo 2 map index table header.
    /// </summary>
    [StructLayout(LayoutKind.Explicit, Size = 20), Serializable]
    internal struct Index
    {
        /// <summary>
        /// Represents the size of a <see cref="Index"/> structure in bytes.
        /// This value is constant.
        /// </summary>
    ...
    public struct ObjectEntry
    {
        ...
        /// <summary>
        /// The object entry's file name offset.
        /// </summary>
        ...
        /// <summary>
        /// The object entry's tag data offset.
        /// </summary>
        public uint TagDataOffset
        {
            get { return tagDataOffset; }
            set { tagDataOffset = value; }
        }
        /// <summary>
