...
namespace Abide.Guerilla.Tags
{
    ...
    [TagGroupAttribute("scenario_decorators_resource", 1684220531u, 4294967293u, typeof(ScenarioDecoratorsResourceBlock))]
    public sealed class ScenarioDecoratorsResourceBlock : AbideTagBlock
    {
        private TagBlockList<DecoratorPlacementDefinitionBlock> decoratorList = new TagBlockList<DecoratorPlacementDefinitionBlock>(1);
        private TagBlockList<ScenarioDecoratorSetPaletteEntryBlock> decoratorPaletteList = new TagBlockList<ScenarioDecoratorSetPaletteEntryBlock>(32);
        [FieldAttribute("Decorator", typeof(TagBlock))]
        [BlockAttribute("decorator_placement_definition_block", 1, typeof(DecoratorPlacementDefinitionBlock))]
        public TagBlock Decorator;
        [FieldAttribute("Decorator Palette", typeof(TagBlock))]
        ...
        public TagBlockList<DecoratorPlacementDefinitionBlock> DecoratorList
        {
            get
            {
        ...
        public TagBlockList<ScenarioDecoratorSetPaletteEntryBlock> DecoratorPaletteList
        {
            get
            {
                return this.decoratorPaletteList;
            }
        }
        ...
        public override void Initialize()
        {
            ...
            this.decoratorPaletteList.Clear();
            this.Decorator = TagBlock.Zero;
            this.DecoratorPalette = TagBlock.Zero;
        }
        public override void Read(BinaryReader reader)
        {
            this.Decorator = reader.ReadInt64();
            this.decoratorList.Read(reader, this.Decorator);
            this.DecoratorPalette = reader.ReadInt64();
            this.decoratorPaletteList.Read(reader, this.DecoratorPalette);
        }
