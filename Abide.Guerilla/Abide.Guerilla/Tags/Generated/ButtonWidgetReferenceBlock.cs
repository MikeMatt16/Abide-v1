...
#pragma warning disable CS1591
	[FieldSet(68, 4)]
	public unsafe struct ButtonWidgetReferenceBlock
	{
		...
		public enum ButtonFlags12Options
		{
			DOESNTTabVertically_0 = 1,
			DOESNTTabHorizontally_1 = 2,
		}
		...
		[Field("bounds", null)]
		public Rectangle2 Bounds6;
		[Field("bitmap", null)]
		public TagReference Bitmap7;
		[Field("bitmap offset#from top-left", null)]
		public Vector2 BitmapOffset8;
		[Field("string id", null)]
		public StringId StringId9;
		[Field("render depth bias", null)]
		public short RenderDepthBias10;
		[Field("mouse region top offset", null)]
		public short MouseRegionTopOffset11;
		[Field("button flags", typeof(ButtonFlags12Options))]
		public int ButtonFlags12;
	}
}
