...
namespace Abide.Guerilla.Tags
{
    ...
    [TagGroupAttribute("scenario_scenery_resource", 711157102u, 4294967293u, typeof(ScenarioSceneryResourceBlock))]
    public sealed class ScenarioSceneryResourceBlock : AbideTagBlock
    {
        ...
        private TagBlockList<ScenarioSceneryPaletteBlock> paletteList = new TagBlockList<ScenarioSceneryPaletteBlock>(256);
        private TagBlockList<ScenarioSceneryBlock> objectsList = new TagBlockList<ScenarioSceneryBlock>(2000);
        private TagBlockList<ScenarioCratePaletteBlock> paletteList1 = new TagBlockList<ScenarioCratePaletteBlock>(256);
        private TagBlockList<ScenarioCrateBlock> objectsList1 = new TagBlockList<ScenarioCrateBlock>(1024);
        ...
        [FieldAttribute("Next Scenery Object ID Salt*", typeof(Int32))]
        ...
        [FieldAttribute("Next Block Object ID Salt*", typeof(Int32))]
        ...
        public TagBlockList<ScenarioSceneryPaletteBlock> PaletteList
        {
            get
            {
        ...
        public TagBlockList<ScenarioSceneryBlock> ObjectsList
        {
            get
            {
        ...
        public TagBlockList<ScenarioCratePaletteBlock> PaletteList1
        {
            get
            {
                return this.paletteList1;
            }
        }
        public TagBlockList<ScenarioCrateBlock> ObjectsList1
        {
            get
            {
                return this.objectsList1;
            }
        }
        ...
        public override void Initialize()
        {
            ...
            this.paletteList1.Clear();
            this.objectsList1.Clear();
            ...
            this.NextSceneryObjectIdSalt = 0;
            this.Palette1 = TagBlock.Zero;
            this.Objects1 = TagBlock.Zero;
            this.NextBlockObjectIdSalt = 0;
        ...
        public override void Read(BinaryReader reader)
        {
            ...
            this.NextSceneryObjectIdSalt = reader.ReadInt32();
            this.Palette1 = reader.ReadInt64();
            this.paletteList1.Read(reader, this.Palette1);
            this.Objects1 = reader.ReadInt64();
            this.objectsList1.Read(reader, this.Objects1);
            this.NextBlockObjectIdSalt = reader.ReadInt32();
