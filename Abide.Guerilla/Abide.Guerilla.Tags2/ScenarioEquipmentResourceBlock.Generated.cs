...
namespace Abide.Guerilla.Tags2
{
    ...
    [Abide.Guerilla.Tags.TagGroupAttribute("scenario_equipment_resource", "*qip", "����", typeof(ScenarioEquipmentResourceBlock))]
    public class ScenarioEquipmentResourceBlock
    {
