...
namespace Abide.Tag.Guerilla.Generated
{
    ...
    public class TagLookup
    {
        ...
        public static Block CreateTagBlock(string tagBlockName)
        {
            ...
            if ((tagBlockName == "sound_pitch_range_block"))
            {
                return new SoundPitchRangeBlock();
            }
            //  sound_permutations_block
            if ((tagBlockName == "sound_permutations_block"))
            {
                return new SoundPermutationsBlock();
            }
            ...
            if ((tagBlockName == "sound_platform_sound_playback_block"))
            {
                return new SoundPlatformSoundPlaybackBlock();
            }
            ...
            if ((tagBlockName == "sound_extra_info_block"))
            {
                return new SoundExtraInfoBlock();
            }
            //  sound_definition_language_permutation_info_block
            if ((tagBlockName == "sound_definition_language_permutation_info_block"))
            {
                return new SoundDefinitionLanguagePermutationInfoBlock();
            }
            //  sound_permutation_raw_info_block
            if ((tagBlockName == "sound_permutation_raw_info_block"))
            {
                return new SoundPermutationRawInfoBlock();
            }
            //  sound_permutation_marker_block
            if ((tagBlockName == "sound_permutation_marker_block"))
            {
                return new SoundPermutationMarkerBlock();
            }
