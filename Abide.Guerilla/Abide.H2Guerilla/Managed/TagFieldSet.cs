...
namespace Abide.H2Guerilla.Managed
{
    ...
    /// </summary>
    public sealed class TagFieldSetDefinition
    {
        /// <summary>
        /// Gets and returns the field set's field list.
        /// </summary>
        public List<TagFieldDefinition> Fields
        {
            get { return fields; }
        }
        /// <summary>
        ...
        private List<TagFieldDefinition> fields;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TagFieldSetDefinition"/> class.
        /// </summary>
        public TagFieldSetDefinition()
        {
            version = new FieldSetVersion();
            fields = new List<TagFieldDefinition>();
        }
        /// <summary>
