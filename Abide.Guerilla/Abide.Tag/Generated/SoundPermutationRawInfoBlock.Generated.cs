...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SoundPermutationRawInfoBlock : Block
    {
        ...
        /// <summary>
        /// Writes the sound_permutation_raw_info_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the sound_permutation_raw_info_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<SoundPermutationMarkerBlock>)(this.Fields[4])).WriteChildren(writer);
        }
    }
}
