...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ShaderTemplateLevelOfDetailBlock : Block
    {
        ...
        /// <summary>
        /// Writes the shader_template_level_of_detail_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the shader_template_level_of_detail_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ShaderTemplatePassReferenceBlock>)(this.Fields[1])).WriteChildren(writer);
        }
    }
}
