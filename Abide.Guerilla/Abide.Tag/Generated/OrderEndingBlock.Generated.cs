...
namespace Abide.Tag.Generated
{
    ...
    public sealed class OrderEndingBlock : Block
    {
        ...
        /// <summary>
        /// Writes the order_ending_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the order_ending_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<TriggerReferences>)(this.Fields[5])).WriteChildren(writer);
        }
    }
}
