...
namespace Abide.Tag.Generated
{
    ...
    public sealed class BipedBlock : Block
    {
        ...
        public BipedBlock()
        {
            this.Fields.Add(new ExplanationField("$$$ BIPED $$$", null));
            ...
            this.Fields.Add(new ExplanationField("jumping and landing", null));
            ...
            this.Fields.Add(new ExplanationField("camera, collision, and autoaim", null));
            ...
            this.Fields.Add(new TagReferenceField("area damage effect"));
            ...
            this.Fields.Add(new TagReferenceField("reanimation character#when the flood reanimate this guy, he turns into a ..."));
            this.Fields.Add(new TagReferenceField("death spawn character#when I die, out of the ashes of my death crawls a ..."));
        ...
        /// <summary>
        /// Writes the biped_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the biped_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ContactPointBlock>)(this.Fields[29])).WriteChildren(writer);
        }
    }
}
