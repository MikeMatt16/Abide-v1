...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ContrailBlock : Block
    {
        ...
        public ContrailBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("point creation", null));
            ...
            this.Fields.Add(new ExplanationField("rendering", null));
            ...
            this.Fields.Add(new ExplanationField("Secondary Map", null));
            this.Fields.Add(new TagReferenceField("bitmap"));
        ...
        /// <summary>
        /// Writes the contrail_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the contrail_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ContrailPointStatesBlock>)(this.Fields[47])).WriteChildren(writer);
        }
    }
}
