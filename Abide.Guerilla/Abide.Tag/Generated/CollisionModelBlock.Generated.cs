...
namespace Abide.Tag.Generated
{
    ...
    public sealed class CollisionModelBlock : Block
    {
        ...
        /// <summary>
        /// Writes the collision_model_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the collision_model_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            ...
            ((BlockField<GlobalErrorReportCategoriesBlock>)(this.Fields[1])).WriteChildren(writer);
            ((BlockField<CollisionModelMaterialBlock>)(this.Fields[3])).WriteChildren(writer);
            ((BlockField<CollisionModelRegionBlock>)(this.Fields[4])).WriteChildren(writer);
            ((BlockField<CollisionModelPathfindingSphereBlock>)(this.Fields[5])).WriteChildren(writer);
            ((BlockField<CollisionModelNodeBlock>)(this.Fields[6])).WriteChildren(writer);
        }
    }
}
