...
namespace Abide.Tag.Generated
{
    ...
    public sealed class DecoratorClassesBlock : Block
    {
        ...
        /// <summary>
        /// Writes the decorator_classes_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the decorator_classes_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<DecoratorPermutationsBlock>)(this.Fields[4])).WriteChildren(writer);
        }
    }
}
