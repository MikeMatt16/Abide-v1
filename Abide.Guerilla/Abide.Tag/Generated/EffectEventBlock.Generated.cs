...
namespace Abide.Tag.Generated
{
    ...
    public sealed class EffectEventBlock : Block
    {
        ...
        /// <summary>
        /// Writes the effect_event_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the effect_event_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<EffectPartBlock>)(this.Fields[4])).WriteChildren(writer);
            ((BlockField<BeamBlock>)(this.Fields[5])).WriteChildren(writer);
            ((BlockField<EffectAccelerationsBlock>)(this.Fields[6])).WriteChildren(writer);
            ((BlockField<ParticleSystemDefinitionBlockNew>)(this.Fields[7])).WriteChildren(writer);
        }
    }
}
