...
namespace Abide.Tag.Generated
{
    ...
    public sealed class StructureBspAudibilityBlock : Block
    {
        ...
        /// <summary>
        /// Writes the structure_bsp_audibility_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the structure_bsp_audibility_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<DoorEncodedPasBlock>)(this.Fields[2])).WriteChildren(writer);
            ((BlockField<ClusterDoorPortalEncodedPasBlock>)(this.Fields[3])).WriteChildren(writer);
            ((BlockField<AiDeafeningEncodedPasBlock>)(this.Fields[4])).WriteChildren(writer);
            ((BlockField<EncodedClusterDistancesBlock>)(this.Fields[5])).WriteChildren(writer);
            ((BlockField<OccluderToMachineDoorMapping>)(this.Fields[6])).WriteChildren(writer);
        }
    }
}
