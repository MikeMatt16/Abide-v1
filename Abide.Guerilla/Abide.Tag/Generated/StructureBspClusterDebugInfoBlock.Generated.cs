...
namespace Abide.Tag.Generated
{
    ...
    public sealed class StructureBspClusterDebugInfoBlock : Block
    {
        ...
        /// <summary>
        /// Writes the structure_bsp_cluster_debug_info_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the structure_bsp_cluster_debug_info_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            ...
            ((BlockField<StructureBspDebugInfoIndicesBlock>)(this.Fields[6])).WriteChildren(writer);
            ((BlockField<StructureBspDebugInfoIndicesBlock>)(this.Fields[7])).WriteChildren(writer);
        }
    }
}
