...
namespace Abide.Tag.Generated
{
    ...
    public sealed class FallingDamageBlock : Block
    {
        ...
        public FallingDamageBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("falling damage"));
            this.Fields.Add(new PadField("", 8));
            this.Fields.Add(new RealField("maximum falling distance:world units"));
            this.Fields.Add(new TagReferenceField("distance damage"));
            this.Fields.Add(new TagReferenceField("vehicle environemtn collision damage effect"));
            this.Fields.Add(new TagReferenceField("vehicle killed unit damage effect"));
            this.Fields.Add(new TagReferenceField("vehicle collision damage"));
            this.Fields.Add(new TagReferenceField("flaming death damage"));
