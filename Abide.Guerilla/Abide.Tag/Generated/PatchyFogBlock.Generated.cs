...
namespace Abide.Tag.Generated
{
    ...
    public sealed class PatchyFogBlock : Block
    {
        ...
        public PatchyFogBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("MOVEMENT MODIFIERS", null));
            ...
            this.Fields.Add(new ExplanationField("NOISE MAP", null));
            this.Fields.Add(new RealField("noise map scale#0 defaults to 1"));
            this.Fields.Add(new TagReferenceField("noise map"));
