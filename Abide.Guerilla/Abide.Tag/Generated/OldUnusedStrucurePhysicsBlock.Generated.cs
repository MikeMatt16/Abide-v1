...
namespace Abide.Tag.Generated
{
    ...
    public sealed class OldUnusedStrucurePhysicsBlock : Block
    {
        ...
        /// <summary>
        /// Writes the old_unused_strucure_physics_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the old_unused_strucure_physics_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<OldUnusedObjectIdentifiersBlock>)(this.Fields[1])).WriteChildren(writer);
        }
    }
}
