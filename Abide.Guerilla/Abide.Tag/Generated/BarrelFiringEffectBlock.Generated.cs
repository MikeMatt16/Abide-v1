...
namespace Abide.Tag.Generated
{
    ...
    public sealed class BarrelFiringEffectBlock : Block
    {
        ...
        public BarrelFiringEffectBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("firing damage#this effect is used when the weapon is loaded and fired normally"));
            this.Fields.Add(new TagReferenceField("misfire damage#this effect is used when the weapon is loaded but fired while over" +
                        "heated"));
            this.Fields.Add(new TagReferenceField("empty damage#this effect is used when the weapon is not loaded"));
        }
        /// <summary>
