...
namespace Abide.Tag.Generated
{
    ...
    public sealed class AiGlobalsBlock : Block
    {
        ...
        public AiGlobalsBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("global dialogue tag"));
        ...
        /// <summary>
        /// Writes the ai_globals_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the ai_globals_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<AiGlobalsGravemindBlock>)(this.Fields[35])).WriteChildren(writer);
        }
    }
}
