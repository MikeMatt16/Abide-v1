...
namespace Abide.Tag.Generated
{
    ...
    public sealed class GameGlobalsDamageBlock : Block
    {
        ...
        /// <summary>
        /// Writes the game_globals_damage_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the game_globals_damage_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<DamageGroupBlock>)(this.Fields[0])).WriteChildren(writer);
        }
    }
}
