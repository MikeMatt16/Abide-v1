...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SoundPitchRangeBlock : Block
    {
        ...
        public SoundPitchRangeBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("pitch control", null));
        ...
        /// <summary>
        /// Writes the sound_pitch_range_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the sound_pitch_range_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<SoundPermutationsBlock>)(this.Fields[7])).WriteChildren(writer);
        }
    }
}
