...
namespace Abide.Tag.Generated
{
    ...
    public sealed class WeaponInterfaceStructBlock : Block
    {
        ...
        {
            this.Fields.Add(new ExplanationField("interface", null));
            ...
            this.Fields.Add(new TagReferenceField("new hud interface"));
        }
        /// <summary>
        ...
        /// <summary>
        /// Writes the weapon_interface_struct_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the weapon_interface_struct_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<WeaponFirstPersonInterfaceBlock>)(this.Fields[2])).WriteChildren(writer);
        }
    }
}
