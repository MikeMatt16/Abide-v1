...
namespace Abide.Tag.Generated
{
    ...
    public sealed class DialogueBlock : Block
    {
        ...
        {
            this.Fields.Add(new TagReferenceField("global dialogue info"));
        ...
        /// <summary>
        /// Writes the dialogue_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the dialogue_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<SoundReferencesBlock>)(this.Fields[2])).WriteChildren(writer);
        }
    }
}
