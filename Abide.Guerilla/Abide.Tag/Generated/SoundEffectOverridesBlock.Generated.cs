...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SoundEffectOverridesBlock : Block
    {
        ...
        /// <summary>
        /// Writes the sound_effect_overrides_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the sound_effect_overrides_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<SoundEffectOverrideParametersBlock>)(this.Fields[1])).WriteChildren(writer);
        }
    }
}
