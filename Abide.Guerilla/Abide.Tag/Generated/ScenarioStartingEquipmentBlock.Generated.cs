...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ScenarioStartingEquipmentBlock : Block
    {
        ...
        public ScenarioStartingEquipmentBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("Item Collection 1"));
            this.Fields.Add(new TagReferenceField("Item Collection 2"));
            this.Fields.Add(new TagReferenceField("Item Collection 3"));
            this.Fields.Add(new TagReferenceField("Item Collection 4"));
            this.Fields.Add(new TagReferenceField("Item Collection 5"));
            this.Fields.Add(new TagReferenceField("Item Collection 6"));
            this.Fields.Add(new PadField("", 48));
        }
        /// <summary>
