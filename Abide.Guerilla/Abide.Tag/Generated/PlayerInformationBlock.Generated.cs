...
namespace Abide.Tag.Generated
{
    ...
    public sealed class PlayerInformationBlock : Block
    {
        ...
        public PlayerInformationBlock()
        {
            ...
            this.Fields.Add(new PadField("", 16));
            this.Fields.Add(new TagReferenceField("coop respawn effect"));
            this.Fields.Add(new LongIntegerField("binoculars zoom count"));
            this.Fields.Add(new RealBoundsField("binoculars zoom range"));
            this.Fields.Add(new TagReferenceField("binoculars zoom in sound"));
            this.Fields.Add(new TagReferenceField("binoculars zoom out sound"));
            this.Fields.Add(new PadField("", 16));
            this.Fields.Add(new TagReferenceField("active camouflage on"));
            this.Fields.Add(new TagReferenceField("active camouflage off"));
            this.Fields.Add(new TagReferenceField("active camouflage error"));
            this.Fields.Add(new TagReferenceField("active camouflage ready"));
            this.Fields.Add(new TagReferenceField("flashlight on"));
            this.Fields.Add(new TagReferenceField("flashlight off"));
            this.Fields.Add(new TagReferenceField("ice cream"));
        }
        /// <summary>
