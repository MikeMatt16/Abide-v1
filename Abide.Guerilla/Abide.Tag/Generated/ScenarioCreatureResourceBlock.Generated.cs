...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ScenarioCreatureResourceBlock : Block
    {
        ...
        /// <summary>
        /// Writes the scenario_creature_resource_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the scenario_creature_resource_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            ...
            ((BlockField<ScenarioCreaturePaletteBlock>)(this.Fields[3])).WriteChildren(writer);
            ((BlockField<ScenarioCreatureBlock>)(this.Fields[4])).WriteChildren(writer);
