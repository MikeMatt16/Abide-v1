...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SoundGlobalMixStructBlock : Block
    {
        ...
        public SoundGlobalMixStructBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("surround center mix", null));
            this.Fields.Add(new RealField("front speaker gain:dB"));
            this.Fields.Add(new RealField("center speaker gain:dB"));
            this.Fields.Add(new ExplanationField("stereo center mix", null));
            this.Fields.Add(new RealField("front speaker gain:dB"));
            this.Fields.Add(new RealField("center speaker gain:dB"));
            this.Fields.Add(new ExplanationField("more sound lovin\'", null));
            this.Fields.Add(new RealField("stereo unspatialized gain:dB"));
            this.Fields.Add(new ExplanationField("last minute values", null));
