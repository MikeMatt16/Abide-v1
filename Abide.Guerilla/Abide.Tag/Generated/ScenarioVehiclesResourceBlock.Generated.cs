...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ScenarioVehiclesResourceBlock : Block
    {
        ...
        /// <summary>
        /// Writes the scenario_vehicles_resource_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the scenario_vehicles_resource_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            ...
            ((BlockField<ScenarioVehiclePaletteBlock>)(this.Fields[3])).WriteChildren(writer);
            ((BlockField<ScenarioVehicleBlock>)(this.Fields[4])).WriteChildren(writer);
