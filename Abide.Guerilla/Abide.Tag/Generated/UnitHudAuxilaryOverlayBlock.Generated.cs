...
namespace Abide.Tag.Generated
{
    ...
    public sealed class UnitHudAuxilaryOverlayBlock : Block
    {
        ...
        /// <summary>
        /// Writes the unit_hud_auxilary_overlay_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the unit_hud_auxilary_overlay_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<GlobalHudMultitextureOverlayDefinition>)(this.Fields[18])).WriteChildren(writer);
        }
    }
}
