...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SquadsBlock : Block
    {
        ...
        public SquadsBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("Actor defaults", null));
        ...
        /// <summary>
        /// Writes the squads_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the squads_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ActorStartingLocationsBlock>)(this.Fields[19])).WriteChildren(writer);
        }
    }
}
