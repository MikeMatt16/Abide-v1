...
namespace Abide.Tag.Generated
{
    ...
    public sealed class HavokVehiclePhysicsStructBlock : Block
    {
        ...
        /// <summary>
        /// Writes the havok_vehicle_physics_struct_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the havok_vehicle_physics_struct_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<AntiGravityPointDefinitionBlock>)(this.Fields[12])).WriteChildren(writer);
            ((BlockField<FrictionPointDefinitionBlock>)(this.Fields[13])).WriteChildren(writer);
            ((BlockField<VehiclePhantomShapeBlock>)(this.Fields[14])).WriteChildren(writer);
        }
    }
}
