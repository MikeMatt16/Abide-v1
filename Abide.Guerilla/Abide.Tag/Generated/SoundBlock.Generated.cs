...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SoundBlock : Block
    {
        ...
        public SoundBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("import properties", null));
        ...
        /// <summary>
        /// Writes the sound_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the sound_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<SoundPitchRangeBlock>)(this.Fields[13])).WriteChildren(writer);
            ((BlockField<SoundPlatformSoundPlaybackBlock>)(this.Fields[14])).WriteChildren(writer);
            ((BlockField<SoundExtraInfoBlock>)(this.Fields[15])).WriteChildren(writer);
        }
    }
}
