...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SoundEncodedDialogueSectionBlock : Block
    {
        ...
        {
            this.Fields.Add(new DataField("encoded data"));
        ...
        /// <summary>
        /// Writes the sound_encoded_dialogue_section_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the sound_encoded_dialogue_section_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<SoundPermutationDialogueInfoBlock>)(this.Fields[1])).WriteChildren(writer);
        }
    }
}
