...
namespace Abide.Tag.Generated
{
    ...
    public sealed class DifficultyBlock : Block
    {
        ...
        {
            this.Fields.Add(new ExplanationField("health", null));
            ...
            this.Fields.Add(new ExplanationField("ranged fire", null));
            ...
            this.Fields.Add(new PadField("", 16));
            this.Fields.Add(new ExplanationField("grenades", null));
            ...
            this.Fields.Add(new PadField("", 16));
            this.Fields.Add(new PadField("", 16));
            this.Fields.Add(new ExplanationField("placement", null));
            ...
            this.Fields.Add(new ExplanationField("vehicles", null));
