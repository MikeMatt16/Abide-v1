...
namespace Abide.Tag.Generated
{
    ...
    public sealed class VisibilityStructBlock : Block
    {
        ...
        public VisibilityStructBlock()
        {
            ...
            this.Fields.Add(new DataField("Projections*"));
            this.Fields.Add(new DataField("Visibility Clusters*"));
            this.Fields.Add(new DataField("Cluster Remap Table*"));
            this.Fields.Add(new DataField("Visibility Volumes*"));
        }
        /// <summary>
