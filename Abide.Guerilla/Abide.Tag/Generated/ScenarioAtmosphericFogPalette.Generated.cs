...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ScenarioAtmosphericFogPalette : Block
    {
        ...
        public ScenarioAtmosphericFogPalette()
        {
            ...
            this.Fields.Add(new ExplanationField("ATMOSPHERIC FOG", null));
            ...
            this.Fields.Add(new RealField("Opaque Distance:World Units#Fog becomes opaque (maximum density) at this distance" +
                        " from viewer."));
            this.Fields.Add(new ExplanationField("SECONDARY FOG", null));
            this.Fields.Add(new RealRgbColorField("Color"));
            this.Fields.Add(new PadField("", 4));
            this.Fields.Add(new RealFractionField("Maximum Density:[0,1]#Fog density clamps to this value."));
            this.Fields.Add(new RealField("Start Distance:World Units#Before this distance, there is no fog."));
            this.Fields.Add(new RealField("Opaque Distance:World Units#Fog becomes opaque (maximum density) at this distance" +
                        " from viewer."));
            this.Fields.Add(new PadField("", 4));
            this.Fields.Add(new ExplanationField("PLANAR FOG OVERRIDE", null));
            ...
            this.Fields.Add(new ExplanationField("PATCHY FOG", null));
            ...
            this.Fields.Add(new TagReferenceField("Patchy Fog"));
            ...
            this.Fields.Add(new ExplanationField("CAMERA IMMERSION OVERRIDE", null));
        ...
        /// <summary>
        /// Writes the scenario_atmospheric_fog_palette tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the scenario_atmospheric_fog_palette tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ScenarioAtmosphericFogMixerBlock>)(this.Fields[28])).WriteChildren(writer);
        }
    }
}
