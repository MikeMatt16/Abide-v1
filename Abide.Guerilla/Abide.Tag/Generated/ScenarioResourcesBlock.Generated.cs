...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ScenarioResourcesBlock : Block
    {
        ...
        /// <summary>
        /// Writes the scenario_resources_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the scenario_resources_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ScenarioResourceReferenceBlock>)(this.Fields[0])).WriteChildren(writer);
            ((BlockField<ScenarioHsSourceReferenceBlock>)(this.Fields[1])).WriteChildren(writer);
            ((BlockField<ScenarioAiResourceReferenceBlock>)(this.Fields[2])).WriteChildren(writer);
        }
    }
}
