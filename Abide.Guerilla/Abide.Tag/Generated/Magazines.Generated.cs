...
namespace Abide.Tag.Generated
{
    ...
    public sealed class Magazines : Block
    {
        ...
        public Magazines()
        {
            ...
            this.Fields.Add(new TagReferenceField("reloading damage effect"));
            this.Fields.Add(new TagReferenceField("chambering effect"));
            this.Fields.Add(new TagReferenceField("chambering damage effect"));
        ...
        /// <summary>
        /// Writes the magazines tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the magazines tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<MagazineObjects>)(this.Fields[16])).WriteChildren(writer);
        }
    }
}
