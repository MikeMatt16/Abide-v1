...
namespace Abide.Tag.Generated
{
    ...
    public sealed class HudBitmapWidgets : Block
    {
        ...
        /// <summary>
        /// Writes the hud_bitmap_widgets tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the hud_bitmap_widgets tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<HudWidgetEffectBlock>)(this.Fields[17])).WriteChildren(writer);
        }
    }
}
