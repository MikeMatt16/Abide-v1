...
namespace Abide.Tag.Generated
{
    ...
    public sealed class AiConversationLineBlock : Block
    {
        ...
        public AiConversationLineBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("variant 1"));
            this.Fields.Add(new TagReferenceField("variant 2"));
            this.Fields.Add(new TagReferenceField("variant 3"));
            this.Fields.Add(new TagReferenceField("variant 4"));
            this.Fields.Add(new TagReferenceField("variant 5"));
            this.Fields.Add(new TagReferenceField("variant 6"));
        }
        /// <summary>
