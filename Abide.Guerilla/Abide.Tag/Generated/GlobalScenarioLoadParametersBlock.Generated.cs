...
namespace Abide.Tag.Generated
{
    ...
    public sealed class GlobalScenarioLoadParametersBlock : Block
    {
        ...
        {
            this.Fields.Add(new ExplanationField("SCENARIO LOAD PARAMETERS", null));
            this.Fields.Add(new TagReferenceField("scenario^"));
            this.Fields.Add(new DataField("parameters"));
