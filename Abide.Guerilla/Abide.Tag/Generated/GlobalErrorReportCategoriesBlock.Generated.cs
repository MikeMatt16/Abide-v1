...
namespace Abide.Tag.Generated
{
    ...
    public sealed class GlobalErrorReportCategoriesBlock : Block
    {
        ...
        /// <summary>
        /// Writes the global_error_report_categories_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the global_error_report_categories_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ErrorReportsBlock>)(this.Fields[6])).WriteChildren(writer);
        }
    }
}
