...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SoundEffectStructDefinitionBlock : Block
    {
        ...
        /// <summary>
        /// Writes the sound_effect_struct_definition_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the sound_effect_struct_definition_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<SoundEffectComponentBlock>)(this.Fields[1])).WriteChildren(writer);
            ((BlockField<SoundEffectOverridesBlock>)(this.Fields[2])).WriteChildren(writer);
            ((BlockField<PlatformSoundEffectCollectionBlock>)(this.Fields[4])).WriteChildren(writer);
        }
    }
}
