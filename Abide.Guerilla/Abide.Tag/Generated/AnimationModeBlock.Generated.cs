...
namespace Abide.Tag.Generated
{
    ...
    public sealed class AnimationModeBlock : Block
    {
        ...
        /// <summary>
        /// Writes the animation_mode_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the animation_mode_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<WeaponClassBlock>)(this.Fields[1])).WriteChildren(writer);
