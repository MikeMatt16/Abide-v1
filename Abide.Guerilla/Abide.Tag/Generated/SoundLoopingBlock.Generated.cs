...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SoundLoopingBlock : Block
    {
        ...
        /// <summary>
        /// Writes the sound_looping_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the sound_looping_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<LoopingSoundTrackBlock>)(this.Fields[5])).WriteChildren(writer);
            ((BlockField<LoopingSoundDetailBlock>)(this.Fields[6])).WriteChildren(writer);
        }
    }
}
