...
namespace Abide.Tag.Generated
{
    ...
    public sealed class WeaponHudOverlaysBlock : Block
    {
        ...
        /// <summary>
        /// Writes the weapon_hud_overlays_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the weapon_hud_overlays_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<WeaponHudOverlayBlock>)(this.Fields[6])).WriteChildren(writer);
        }
    }
}
