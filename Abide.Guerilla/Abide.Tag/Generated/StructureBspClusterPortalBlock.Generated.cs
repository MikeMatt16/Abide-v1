...
namespace Abide.Tag.Generated
{
    ...
    public sealed class StructureBspClusterPortalBlock : Block
    {
        ...
        /// <summary>
        /// Writes the structure_bsp_cluster_portal_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the structure_bsp_cluster_portal_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<StructureBspClusterPortalVertexBlock>)(this.Fields[6])).WriteChildren(writer);
        }
    }
}
