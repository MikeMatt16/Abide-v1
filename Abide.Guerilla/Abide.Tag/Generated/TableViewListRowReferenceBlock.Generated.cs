...
namespace Abide.Tag.Generated
{
    ...
    public sealed class TableViewListRowReferenceBlock : Block
    {
        ...
        /// <summary>
        /// Writes the table_view_list_row_reference_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the table_view_list_row_reference_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<TableViewListItemReferenceBlock>)(this.Fields[3])).WriteChildren(writer);
        }
    }
}
