...
namespace Abide.Tag.Generated
{
    ...
    public sealed class WeaponBarrels : Block
    {
        ...
        public WeaponBarrels()
        {
            ...
            this.Fields.Add(new ExplanationField("firing", null));
            ...
            this.Fields.Add(new ExplanationField("prediction properties", null));
            ...
            this.Fields.Add(new ExplanationField("error", null));
            this.Fields.Add(new RealField("acceleration time:seconds#the continuous firing time it takes for the weapon to a" +
            ...
            this.Fields.Add(new RealBoundsField("damage error#the range of angles (in degrees) that a damaged weapon will skew fir" +
                        "e"));
            this.Fields.Add(new ExplanationField("dual weapon error", null));
            this.Fields.Add(new RealField("acceleration time:seconds#the continuous firing time it takes for the weapon to a" +
                        "chieve its final error"));
            this.Fields.Add(new RealField("deceleration time:seconds#the continuous idle time it takes for the weapon to ret" +
                        "urn to its initial error"));
            ...
            this.Fields.Add(new TagReferenceField("projectile"));
            this.Fields.Add(new StructField<WeaponBarrelDamageEffectStructBlock>("eh"));
            this.Fields.Add(new ExplanationField("misc", null));
            ...
            this.Fields.Add(new RealField("overload time:seconds#the next trigger fires this often while holding down this t" +
                        "rigger"));
            this.Fields.Add(new ExplanationField("angle change (recoil)", null));
        ...
        /// <summary>
        /// Writes the weapon_barrels tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the weapon_barrels tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<BarrelFiringEffectBlock>)(this.Fields[54])).WriteChildren(writer);
        }
    }
}
