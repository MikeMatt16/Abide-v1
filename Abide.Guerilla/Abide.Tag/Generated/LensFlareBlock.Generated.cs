...
namespace Abide.Tag.Generated
{
    ...
    public sealed class LensFlareBlock : Block
    {
        ...
        public LensFlareBlock()
        {
            ...
            this.Fields.Add(new SkipField("", 4));
            this.Fields.Add(new ExplanationField("OCCLUSION", null));
            ...
            this.Fields.Add(new ExplanationField("ANIMATION", null));
        ...
        /// <summary>
        /// Writes the lens_flare_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the lens_flare_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<LensFlareReflectionBlock>)(this.Fields[21])).WriteChildren(writer);
            ((BlockField<LensFlareScalarAnimationBlock>)(this.Fields[25])).WriteChildren(writer);
            ((BlockField<LensFlareColorAnimationBlock>)(this.Fields[26])).WriteChildren(writer);
            ((BlockField<LensFlareScalarAnimationBlock>)(this.Fields[27])).WriteChildren(writer);
        }
    }
}
