...
namespace Abide.Tag.Generated
{
    ...
    public sealed class RenderModelSectionDataBlock : Block
    {
        ...
        /// <summary>
        /// Writes the render_model_section_data_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the render_model_section_data_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<RenderModelNodeMapBlock>)(this.Fields[2])).WriteChildren(writer);
        }
    }
}
