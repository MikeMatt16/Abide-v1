...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ModelRegionBlock : Block
    {
        ...
        /// <summary>
        /// Writes the model_region_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the model_region_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ModelPermutationBlock>)(this.Fields[4])).WriteChildren(writer);
        }
    }
}
