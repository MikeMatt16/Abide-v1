...
namespace Abide.Tag.Generated
{
    ...
    public sealed class AiDialogueGlobalsBlock : Block
    {
        ...
        /// <summary>
        /// Writes the ai_dialogue_globals_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the ai_dialogue_globals_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<VocalizationDefinitionsBlock0>)(this.Fields[0])).WriteChildren(writer);
            ((BlockField<VocalizationPatternsBlock>)(this.Fields[1])).WriteChildren(writer);
            ((BlockField<DialogueDataBlock>)(this.Fields[3])).WriteChildren(writer);
            ((BlockField<InvoluntaryDataBlock>)(this.Fields[4])).WriteChildren(writer);
        }
    }
}
