...
namespace Abide.Tag.Generated
{
    ...
    public sealed class PhysicsBlock : Block
    {
        ...
        /// <summary>
        /// Writes the physics_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the physics_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<InertialMatrixBlock>)(this.Fields[21])).WriteChildren(writer);
            ((BlockField<PoweredMassPointBlock>)(this.Fields[22])).WriteChildren(writer);
            ((BlockField<MassPointBlock>)(this.Fields[23])).WriteChildren(writer);
        }
    }
}
