...
namespace Abide.Tag.Generated
{
    ...
    public sealed class AnimationGraphContentsStructBlock : Block
    {
        ...
        {
            this.Fields.Add(new ExplanationField("MODE-n-STATE GRAPH", null));
            this.Fields.Add(new BlockField<AnimationModeBlock>("modes|AABBCC", 512));
            this.Fields.Add(new ExplanationField("SPECIAL CASE ANIMS", null));
        ...
        /// <summary>
        /// Writes the animation_graph_contents_struct_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the animation_graph_contents_struct_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<AnimationModeBlock>)(this.Fields[1])).WriteChildren(writer);
            ((BlockField<VehicleSuspensionBlock>)(this.Fields[3])).WriteChildren(writer);
            ((BlockField<ObjectAnimationBlock>)(this.Fields[4])).WriteChildren(writer);
        }
    }
}
