...
namespace Abide.Tag.Generated
{
    ...
    public sealed class CharacterFiringPatternPropertiesBlock : Block
    {
        ...
        /// <summary>
        /// Writes the character_firing_pattern_properties_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the character_firing_pattern_properties_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<CharacterFiringPatternBlock>)(this.Fields[1])).WriteChildren(writer);
        }
    }
}
