...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ScenarioDecoratorsResourceBlock : Block
    {
        ...
        /// <summary>
        /// Writes the scenario_decorators_resource_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the scenario_decorators_resource_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<DecoratorPlacementDefinitionBlock>)(this.Fields[0])).WriteChildren(writer);
            ((BlockField<ScenarioDecoratorSetPaletteEntryBlock>)(this.Fields[1])).WriteChildren(writer);
        }
    }
}
