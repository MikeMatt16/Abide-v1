...
namespace Abide.Tag.Generated
{
    ...
    public sealed class LocalStringIdListSectionReferenceBlock : Block
    {
        ...
        /// <summary>
        /// Writes the local_string_id_list_section_reference_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the local_string_id_list_section_reference_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<LocalStringIdListStringReferenceBlock>)(this.Fields[1])).WriteChildren(writer);
        }
    }
}
