...
namespace Abide.Tag.Generated
{
    ...
    public sealed class StructureBspInstancedGeometryDefinitionBlock : Block
    {
        ...
        /// <summary>
        /// Writes the structure_bsp_instanced_geometry_definition_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the structure_bsp_instanced_geometry_definition_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<CollisionBspPhysicsBlock>)(this.Fields[5])).WriteChildren(writer);
            ((BlockField<StructureBspLeafBlock>)(this.Fields[6])).WriteChildren(writer);
            ((BlockField<StructureBspSurfaceReferenceBlock>)(this.Fields[7])).WriteChildren(writer);
        }
    }
}
