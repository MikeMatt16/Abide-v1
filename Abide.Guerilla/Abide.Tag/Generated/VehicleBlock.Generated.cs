...
namespace Abide.Tag.Generated
{
    ...
    public sealed class VehicleBlock : Block
    {
        ...
        public VehicleBlock()
        {
            this.Fields.Add(new ExplanationField("$$$ VEHICLE $$$", null));
            ...
            this.Fields.Add(new ExplanationField("steering overdampening", null));
            ...
            this.Fields.Add(new ExplanationField("engine", null));
            ...
            this.Fields.Add(new ExplanationField("sounds and effects", null));
            this.Fields.Add(new TagReferenceField("suspension sound"));
            this.Fields.Add(new TagReferenceField("crash sound"));
            this.Fields.Add(new TagReferenceField("UNUSED*"));
            this.Fields.Add(new TagReferenceField("special effect"));
            this.Fields.Add(new TagReferenceField("unused effect"));
        ...
        /// <summary>
        /// Writes the vehicle_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the vehicle_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<GearBlock>)(this.Fields[37])).WriteChildren(writer);
        }
    }
}
