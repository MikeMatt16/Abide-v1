...
namespace Abide.Tag.Generated
{
    ...
    public sealed class MultiplayerConstantsBlock : Block
    {
        ...
        public MultiplayerConstantsBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("bomb explode effect"));
            this.Fields.Add(new TagReferenceField("bomb explode dmg effect"));
            this.Fields.Add(new TagReferenceField("bomb defuse effect"));
