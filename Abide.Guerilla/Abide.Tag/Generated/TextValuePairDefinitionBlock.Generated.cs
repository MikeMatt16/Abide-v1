...
namespace Abide.Tag.Generated
{
    ...
    public sealed class TextValuePairDefinitionBlock : Block
    {
        ...
        public TextValuePairDefinitionBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("string list"));
        ...
        /// <summary>
        /// Writes the text_value_pair_definition_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the text_value_pair_definition_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<TextValuePairReferenceBlock>)(this.Fields[6])).WriteChildren(writer);
        }
    }
}
