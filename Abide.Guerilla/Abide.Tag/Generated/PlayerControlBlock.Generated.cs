...
namespace Abide.Tag.Generated
{
    ...
    /// </summary>
    public sealed class PlayerControlBlock : Block
    {
        /// <summary>
        ...
        public PlayerControlBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("crosshair", null));
            this.Fields.Add(new RealPoint2dField("crosshair location#-1..1, 0 is middle of the screen"));
            this.Fields.Add(new ExplanationField("sprinting", null));
            ...
            this.Fields.Add(new ExplanationField("looking", null));
        ...
        /// <summary>
        /// Writes the player_control_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the player_control_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<LookFunctionBlock>)(this.Fields[28])).WriteChildren(writer);
        }
    }
}
