...
namespace Abide.Tag.Generated
{
    ...
    public sealed class DecoratorCacheBlockDataBlock : Block
    {
        ...
        /// <summary>
        /// Writes the decorator_cache_block_data_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the decorator_cache_block_data_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<DecoratorPlacementBlock>)(this.Fields[0])).WriteChildren(writer);
            ((BlockField<DecalVerticesBlock>)(this.Fields[1])).WriteChildren(writer);
            ((BlockField<IndicesBlock>)(this.Fields[2])).WriteChildren(writer);
            ((BlockField<SpriteVerticesBlock>)(this.Fields[5])).WriteChildren(writer);
            ((BlockField<IndicesBlock>)(this.Fields[6])).WriteChildren(writer);
        }
    }
}
