...
namespace Abide.Tag.Generated
{
    ...
    public sealed class StructurePortalDeviceMappingBlock : Block
    {
        ...
        /// <summary>
        /// Writes the structure_portal_device_mapping_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the structure_portal_device_mapping_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<StructureDevicePortalAssociationBlock>)(this.Fields[0])).WriteChildren(writer);
            ((BlockField<GamePortalToPortalMappingBlock>)(this.Fields[1])).WriteChildren(writer);
        }
    }
}
