...
namespace Abide.Tag.Generated
{
    ...
    public sealed class GlobalWindModelStructBlock : Block
    {
        ...
        /// <summary>
        /// Writes the global_wind_model_struct_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the global_wind_model_struct_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<GloalWindPrimitivesBlock>)(this.Fields[20])).WriteChildren(writer);
        }
    }
}
