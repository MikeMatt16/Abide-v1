...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ListReferenceBlock : Block
    {
        ...
        /// <summary>
        /// Writes the list_reference_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the list_reference_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<STextValuePairReferenceBlockUNUSED>)(this.Fields[7])).WriteChildren(writer);
        }
    }
}
