...
namespace Abide.Tag.Generated
{
    ...
    /// <summary>
    /// Represents the generated game_engine_ctf_event_block tag block.
    /// </summary>
    public sealed class GameEngineCtfEventBlock : Block
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GameEngineCtfEventBlock"/> class.
        /// </summary>
        public GameEngineCtfEventBlock()
        {
            this.Fields.Add(new WordFlagsField("flags", "quantity message"));
            this.Fields.Add(new PadField("", 2));
            this.Fields.Add(new EnumField("event^", "game start", "flag taken", "flag dropped", "flag returned by player", "flag returned by timeout", "flag captured", "flag new defensive team", "flag return faliure", "side switch tick", "side switch final tick", "side switch 30 seconds", "side switch 10 seconds", "flag contested", "flag capture faliure"));
        ...
        public override string Name
        {
            get
            {
                return "game_engine_ctf_event_block";
            }
        }
        /// <summary>
        /// Gets and returns the display name of the game_engine_ctf_event_block tag block.
        /// </summary>
        ...
        /// <summary>
        /// Gets and returns the maximum number of elements allowed of the game_engine_ctf_event_block tag block.
        /// </summary>
        ...
        /// <summary>
        /// Gets and returns the alignment of the game_engine_ctf_event_block tag block.
        /// </summary>
        ...
        /// <summary>
        /// Writes the game_engine_ctf_event_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the game_engine_ctf_event_block tag block.</param>
