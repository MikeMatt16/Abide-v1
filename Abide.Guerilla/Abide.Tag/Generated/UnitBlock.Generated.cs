...
namespace Abide.Tag.Generated
{
    ...
    public sealed class UnitBlock : Block
    {
        ...
        public UnitBlock()
        {
            this.Fields.Add(new ExplanationField("$$$ UNIT $$$", null));
            ...
            this.Fields.Add(new TagReferenceField("integrated light toggle"));
            ...
            this.Fields.Add(new TagReferenceField("melee damage"));
            ...
            this.Fields.Add(new ExplanationField("Boost", null));
            this.Fields.Add(new StructField<UnitBoostStructBlock>("boost"));
            this.Fields.Add(new ExplanationField("Lipsync", null));
        ...
        /// <summary>
        /// Writes the unit_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the unit_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<UnitPosturesBlock>)(this.Fields[36])).WriteChildren(writer);
            ((BlockField<UnitHudReferenceBlock>)(this.Fields[37])).WriteChildren(writer);
            ((BlockField<DialogueVariantBlock>)(this.Fields[38])).WriteChildren(writer);
            ((BlockField<PoweredSeatBlock>)(this.Fields[42])).WriteChildren(writer);
            ((BlockField<UnitWeaponBlock>)(this.Fields[43])).WriteChildren(writer);
            ((BlockField<UnitSeatBlock>)(this.Fields[44])).WriteChildren(writer);
        }
    }
}
