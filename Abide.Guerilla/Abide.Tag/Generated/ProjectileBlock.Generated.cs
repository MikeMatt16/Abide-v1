...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ProjectileBlock : Block
    {
        ...
        {
            this.Fields.Add(new ExplanationField("$$$ PROJECTILE $$$", null));
            ...
            this.Fields.Add(new ExplanationField("detonation", null));
            ...
            this.Fields.Add(new TagReferenceField("detonation started"));
            this.Fields.Add(new TagReferenceField("detonation effect (airborne)"));
            this.Fields.Add(new TagReferenceField("detonation effect (ground)"));
            this.Fields.Add(new TagReferenceField("detonation damage"));
            this.Fields.Add(new TagReferenceField("attached detonation damage"));
            this.Fields.Add(new TagReferenceField("super detonation"));
            this.Fields.Add(new StructField<SuperDetonationDamageStructBlock>("your momma!"));
            this.Fields.Add(new TagReferenceField("detonation sound"));
            ...
            this.Fields.Add(new TagReferenceField("super attached detonation damage"));
            this.Fields.Add(new RealField("material effect radius#radius within we will generate material effects"));
            this.Fields.Add(new ExplanationField("flyby/impact", null));
            this.Fields.Add(new TagReferenceField("flyby sound"));
            this.Fields.Add(new TagReferenceField("impact effect"));
            this.Fields.Add(new TagReferenceField("impact damage"));
            this.Fields.Add(new ExplanationField("boarding fields", null));
            this.Fields.Add(new RealField("boarding detonation time"));
            this.Fields.Add(new TagReferenceField("boarding detonation damage"));
            this.Fields.Add(new TagReferenceField("boarding attached detonation damage"));
            this.Fields.Add(new ExplanationField("physics", null));
        ...
        /// <summary>
        /// Writes the projectile_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the projectile_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ProjectileMaterialResponseBlock>)(this.Fields[46])).WriteChildren(writer);
        }
    }
}
