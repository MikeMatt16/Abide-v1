...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SoundEffectTemplateBlock : Block
    {
        ...
        /// <summary>
        /// Writes the sound_effect_template_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the sound_effect_template_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<SoundEffectTemplatesBlock>)(this.Fields[0])).WriteChildren(writer);
            ((BlockField<SoundEffectTemplateAdditionalSoundInputBlock>)(this.Fields[2])).WriteChildren(writer);
            ((BlockField<PlatformSoundEffectTemplateCollectionBlock>)(this.Fields[3])).WriteChildren(writer);
        }
    }
}
