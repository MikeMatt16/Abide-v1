...
namespace Abide.Tag.Generated
{
    ...
    public sealed class MaterialEffectsBlock : Block
    {
        ...
        /// <summary>
        /// Writes the material_effects_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the material_effects_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<MaterialEffectBlockV2>)(this.Fields[0])).WriteChildren(writer);
        }
    }
}
