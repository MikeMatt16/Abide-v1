...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ObjectBlock : Block
    {
        ...
        public ObjectBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("model"));
            this.Fields.Add(new TagReferenceField("crate object"));
            this.Fields.Add(new TagReferenceField("modifier shader"));
            this.Fields.Add(new TagReferenceField("creation effect"));
            ...
            this.Fields.Add(new ExplanationField("Applying collision damage", null));
            ...
            this.Fields.Add(new ExplanationField("Game collision damage parameters", null));
            ...
            this.Fields.Add(new ExplanationField("Absolute collision damage parameters", null));
        ...
        /// <summary>
        /// Writes the object_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the object_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ObjectAiPropertiesBlock>)(this.Fields[17])).WriteChildren(writer);
            ((BlockField<ObjectFunctionBlock>)(this.Fields[18])).WriteChildren(writer);
            ((BlockField<ObjectAttachmentBlock>)(this.Fields[33])).WriteChildren(writer);
            ((BlockField<ObjectWidgetBlock>)(this.Fields[34])).WriteChildren(writer);
            ((BlockField<OldObjectFunctionBlock>)(this.Fields[35])).WriteChildren(writer);
            ((BlockField<ObjectChangeColors>)(this.Fields[36])).WriteChildren(writer);
            ((BlockField<PredictedResourceBlock>)(this.Fields[37])).WriteChildren(writer);
        }
    }
}
