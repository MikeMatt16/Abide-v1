...
namespace Abide.Tag.Generated
{
    ...
    public sealed class LightBlock : Block
    {
        ...
        public LightBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("SHAPE", null));
            ...
            this.Fields.Add(new PadField("", 2));
            this.Fields.Add(new ExplanationField("SPHERE LIGHT", null));
            ...
            this.Fields.Add(new ExplanationField("FRUSTUM LIGHT", null));
            ...
            this.Fields.Add(new ExplanationField("GEL", null));
            this.Fields.Add(new TagReferenceField("gel map#must be a cubemap for spherical light and a 2d texture for frustum light"));
            this.Fields.Add(new EnumField("specular mask", "default", "none (no mask)", "gel alpha", "gel color"));
            this.Fields.Add(new PadField("", 2));
            this.Fields.Add(new PadField("", 4));
            this.Fields.Add(new ExplanationField("FALLOFF", null));
            ...
            this.Fields.Add(new ExplanationField("LENS FLARE", null));
            this.Fields.Add(new TagReferenceField("lens flare"));
            this.Fields.Add(new RealField("bounding radius:world units#used to generate a bounding radius for lensflare-only" +
                        " lights"));
            this.Fields.Add(new TagReferenceField("light volume"));
            this.Fields.Add(new ExplanationField("RADIOSITY", null));
            ...
            this.Fields.Add(new ExplanationField("EFFECT PARAMETERS", null));
            ...
            this.Fields.Add(new ExplanationField("DISTANCE FADING PARAMETERS", null));
            ...
            this.Fields.Add(new PadField("", 2));
            this.Fields.Add(new ExplanationField("ANIMATION PARAMETERS", null));
            ...
            this.Fields.Add(new ExplanationField("SHADER", null));
        ...
        /// <summary>
        /// Writes the light_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the light_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<LightBrightnessAnimationBlock>)(this.Fields[55])).WriteChildren(writer);
            ((BlockField<LightColorAnimationBlock>)(this.Fields[56])).WriteChildren(writer);
            ((BlockField<LightGelAnimationBlock>)(this.Fields[57])).WriteChildren(writer);
        }
    }
}
