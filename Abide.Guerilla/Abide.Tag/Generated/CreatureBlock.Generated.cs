...
namespace Abide.Tag.Generated
{
    ...
    public sealed class CreatureBlock : Block
    {
        ...
        {
            this.Fields.Add(new ExplanationField("$$$ CREATURE $$$", null));
            ...
            this.Fields.Add(new TagReferenceField("impact shield damage#if not specified, uses \'impact damage\'"));
            this.Fields.Add(new ExplanationField("death and destruction", null));
