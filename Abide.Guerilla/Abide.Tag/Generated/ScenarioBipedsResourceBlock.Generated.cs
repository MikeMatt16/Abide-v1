...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ScenarioBipedsResourceBlock : Block
    {
        ...
        /// <summary>
        /// Writes the scenario_bipeds_resource_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the scenario_bipeds_resource_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            ...
            ((BlockField<ScenarioBipedPaletteBlock>)(this.Fields[3])).WriteChildren(writer);
            ((BlockField<ScenarioBipedBlock>)(this.Fields[4])).WriteChildren(writer);
