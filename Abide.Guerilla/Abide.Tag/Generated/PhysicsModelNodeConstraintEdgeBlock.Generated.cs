...
namespace Abide.Tag.Generated
{
    ...
    public sealed class PhysicsModelNodeConstraintEdgeBlock : Block
    {
        ...
        /// <summary>
        /// Writes the physics_model_node_constraint_edge_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the physics_model_node_constraint_edge_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<PhysicsModelConstraintEdgeConstraintBlock>)(this.Fields[3])).WriteChildren(writer);
        }
    }
}
