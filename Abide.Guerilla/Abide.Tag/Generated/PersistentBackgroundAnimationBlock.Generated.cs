...
namespace Abide.Tag.Generated
{
    ...
    public sealed class PersistentBackgroundAnimationBlock : Block
    {
        ...
        /// <summary>
        /// Writes the persistent_background_animation_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the persistent_background_animation_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<BackgroundAnimationKeyframeReferenceBlock>)(this.Fields[2])).WriteChildren(writer);
        }
    }
}
