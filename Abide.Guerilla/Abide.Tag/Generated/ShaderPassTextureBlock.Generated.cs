...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ShaderPassTextureBlock : Block
    {
        ...
        /// <summary>
        /// Writes the shader_pass_texture_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the shader_pass_texture_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ShaderTextureStateAddressStateBlock>)(this.Fields[9])).WriteChildren(writer);
            ((BlockField<ShaderTextureStateFilterStateBlock>)(this.Fields[10])).WriteChildren(writer);
            ((BlockField<ShaderTextureStateKillStateBlock>)(this.Fields[11])).WriteChildren(writer);
            ((BlockField<ShaderTextureStateMiscStateBlock>)(this.Fields[12])).WriteChildren(writer);
            ((BlockField<ShaderTextureStateConstantBlock>)(this.Fields[13])).WriteChildren(writer);
        }
    }
}
