...
namespace Abide.Tag.Generated
{
    ...
    public sealed class MeleeDamageParametersStructBlock : Block
    {
        ...
        public MeleeDamageParametersStructBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("melee combo damage", null));
            this.Fields.Add(new TagReferenceField("1st hit melee damage"));
            this.Fields.Add(new TagReferenceField("1st hit melee response"));
            this.Fields.Add(new TagReferenceField("2nd hit melee damage"));
            this.Fields.Add(new TagReferenceField("2nd hit melee response"));
            this.Fields.Add(new TagReferenceField("3rd hit melee damage"));
            this.Fields.Add(new TagReferenceField("3rd hit melee response"));
            this.Fields.Add(new TagReferenceField("lunge melee damage#this is only important for the energy sword"));
            this.Fields.Add(new TagReferenceField("lunge melee response#this is only important for the energy sword"));
        }
        /// <summary>
