...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ParticleSystemDefinitionBlockNew : Block
    {
        ...
        /// <summary>
        /// Writes the particle_system_definition_block_new tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the particle_system_definition_block_new tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ParticleSystemEmitterDefinitionBlock>)(this.Fields[14])).WriteChildren(writer);
        }
    }
}
