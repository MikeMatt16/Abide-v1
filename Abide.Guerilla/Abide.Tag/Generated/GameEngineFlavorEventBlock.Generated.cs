...
namespace Abide.Tag.Generated
{
    ...
    public sealed class GameEngineFlavorEventBlock : Block
    {
        ...
        /// </summary>
        public GameEngineFlavorEventBlock()
        {
            this.Fields.Add(new WordFlagsField("flags", "quantity message"));
            this.Fields.Add(new PadField("", 2));
            this.Fields.Add(new EnumField("event^", "double kill", "triple kill", "killtacular", "killing spree", "running riot", "well placed kill", "broke killing spree", "kill frenzy", "killtrocity", "killimajaro", "15 in a row", "20 in a row", "25 in a row"));
        ...
        /// <summary>
        /// Gets and returns the name of the game_engine_flavor_event_block tag block.
        /// </summary>
        public override string Name
        {
            get
            {
                return "game_engine_flavor_event_block";
            }
        }
        /// <summary>
        /// Gets and returns the display name of the game_engine_flavor_event_block tag block.
        /// </summary>
        ...
        /// <summary>
        /// Gets and returns the maximum number of elements allowed of the game_engine_flavor_event_block tag block.
        /// </summary>
        ...
        /// <summary>
        /// Gets and returns the alignment of the game_engine_flavor_event_block tag block.
        /// </summary>
        ...
        /// <summary>
        /// Writes the game_engine_flavor_event_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the game_engine_flavor_event_block tag block.</param>
