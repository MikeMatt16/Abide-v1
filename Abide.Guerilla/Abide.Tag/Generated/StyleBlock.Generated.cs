...
namespace Abide.Tag.Generated
{
    ...
    public sealed class StyleBlock : Block
    {
        ...
        public StyleBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("Combat status decay options", null));
            this.Fields.Add(new EnumField("Combat status decay options", "Latch at Idle", "Latch at Alert", "Latch at Combat"));
            this.Fields.Add(new PadField("", 2));
            this.Fields.Add(new ExplanationField("Atittude", null));
            ...
            this.Fields.Add(new ExplanationField("Style Behavior Control", null));
        ...
        /// <summary>
        /// Writes the style_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the style_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<SpecialMovementBlock>)(this.Fields[26])).WriteChildren(writer);
            ((BlockField<BehaviorNamesBlock>)(this.Fields[27])).WriteChildren(writer);
        }
    }
}
