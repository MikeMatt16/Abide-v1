...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ScenarioSceneryResourceBlock : Block
    {
        ...
        /// <summary>
        /// Writes the scenario_scenery_resource_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the scenario_scenery_resource_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            ...
            ((BlockField<ScenarioSceneryPaletteBlock>)(this.Fields[3])).WriteChildren(writer);
            ((BlockField<ScenarioSceneryBlock>)(this.Fields[4])).WriteChildren(writer);
            ((BlockField<ScenarioCratePaletteBlock>)(this.Fields[6])).WriteChildren(writer);
            ((BlockField<ScenarioCrateBlock>)(this.Fields[7])).WriteChildren(writer);
            ((BlockField<GScenarioEditorFolderBlock>)(this.Fields[9])).WriteChildren(writer);
        }
    }
}
