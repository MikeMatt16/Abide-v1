...
namespace Abide.Tag.Generated
{
    ...
    public sealed class HudWidgetEffectBlock : Block
    {
        ...
        {
            this.Fields.Add(new ExplanationField("WIDGET EFFECTS", null));
            this.Fields.Add(new WordFlagsField("flags", "apply scale", "apply theta", "apply offset"));
            this.Fields.Add(new PadField("", 2));
            this.Fields.Add(new ExplanationField("horizontal and vertical scale", null));
            this.Fields.Add(new StructField<HudWidgetEffectFunctionStructBlock>("your mom"));
            this.Fields.Add(new StructField<HudWidgetEffectFunctionStructBlock>("your mom"));
            this.Fields.Add(new ExplanationField("theta", null));
            this.Fields.Add(new StructField<HudWidgetEffectFunctionStructBlock>("your mom"));
            this.Fields.Add(new ExplanationField("horizontal and vertical offset", null));
            this.Fields.Add(new StructField<HudWidgetEffectFunctionStructBlock>("your mom"));
            this.Fields.Add(new StructField<HudWidgetEffectFunctionStructBlock>("your mom"));
        }
        /// <summary>
