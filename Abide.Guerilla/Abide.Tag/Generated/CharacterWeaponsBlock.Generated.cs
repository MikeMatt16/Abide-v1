...
namespace Abide.Tag.Generated
{
    ...
    public sealed class CharacterWeaponsBlock : Block
    {
        ...
        public CharacterWeaponsBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("Combat ranges", null));
            ...
            this.Fields.Add(new ExplanationField("Ballistic Firing", null));
            ...
            this.Fields.Add(new RealBoundsField("Ballistic fraction bounds:[0-1]#Controls speed and degree of arc. 0 = high, slow," +
                        " 1 = low, fast"));
            this.Fields.Add(new ExplanationField("Behavior", null));
            ...
            this.Fields.Add(new RealVector3dField("custom crouch gun offset#custom crouching gun offset for overriding the default i" +
                        "n the base actor"));
            this.Fields.Add(new ExplanationField("special-case firing properties", null));
            ...
            this.Fields.Add(new ExplanationField("Weapon drop when killed", null));
            ...
            this.Fields.Add(new ShortBoundsField("drop weapon ammo#total number of rounds in the weapon that we drop (ignored for e" +
                        "nergy weapons)"));
            this.Fields.Add(new ExplanationField("Accuracy", null));
            ...
            this.Fields.Add(new TagReferenceField("weapon melee damage"));
        }
        /// <summary>
        ...
        /// <summary>
        /// Writes the character_weapons_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the character_weapons_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<CharacterFiringPatternBlock>)(this.Fields[39])).WriteChildren(writer);
        }
    }
}
