...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ScenarioLightsResourceBlock : Block
    {
        ...
        /// <summary>
        /// Writes the scenario_lights_resource_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the scenario_lights_resource_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            ...
            ((BlockField<ScenarioLightPaletteBlock>)(this.Fields[3])).WriteChildren(writer);
            ((BlockField<ScenarioLightBlock>)(this.Fields[4])).WriteChildren(writer);
