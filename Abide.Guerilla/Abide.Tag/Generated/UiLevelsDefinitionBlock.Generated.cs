...
namespace Abide.Tag.Generated
{
    ...
    public sealed class UiLevelsDefinitionBlock : Block
    {
        ...
        /// <summary>
        /// Writes the ui_levels_definition_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the ui_levels_definition_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<UiCampaignBlock>)(this.Fields[0])).WriteChildren(writer);
