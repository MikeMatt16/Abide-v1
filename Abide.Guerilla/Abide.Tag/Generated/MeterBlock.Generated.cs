...
namespace Abide.Tag.Generated
{
    ...
    public sealed class MeterBlock : Block
    {
        ...
        public MeterBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("stencil bitmaps#two bitmaps specifying the mask and the meter levels"));
            this.Fields.Add(new TagReferenceField("source bitmap#optional bitmap to draw into the unmasked regions of the meter (mod" +
                        "ulated by the colors below)"));
            ...
            this.Fields.Add(new PadField("", 20));
            this.Fields.Add(new DataField("encoded stencil"));
        }
        /// <summary>
