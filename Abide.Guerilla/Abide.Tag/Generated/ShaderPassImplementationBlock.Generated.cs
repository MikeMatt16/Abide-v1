...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ShaderPassImplementationBlock : Block
    {
        ...
        public ShaderPassImplementationBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("VERTEX SHADER", null));
            ...
            this.Fields.Add(new DataField("Pixel Shader Code [NO LONGER USED]"));
            this.Fields.Add(new ExplanationField("STATE", null));
            ...
            this.Fields.Add(new TagReferenceField("Pixel Shader"));
        }
        /// <summary>
        ...
        /// <summary>
        /// Writes the shader_pass_implementation_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the shader_pass_implementation_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<ShaderPassTextureBlock>)(this.Fields[2])).WriteChildren(writer);
            ((BlockField<ShaderPassVertexShaderConstantBlock>)(this.Fields[5])).WriteChildren(writer);
            ((BlockField<ShaderStateChannelsStateBlock>)(this.Fields[12])).WriteChildren(writer);
            ((BlockField<ShaderStateAlphaBlendStateBlock>)(this.Fields[13])).WriteChildren(writer);
            ((BlockField<ShaderStateAlphaTestStateBlock>)(this.Fields[14])).WriteChildren(writer);
            ((BlockField<ShaderStateDepthStateBlock>)(this.Fields[15])).WriteChildren(writer);
            ((BlockField<ShaderStateCullStateBlock>)(this.Fields[16])).WriteChildren(writer);
            ((BlockField<ShaderStateFillStateBlock>)(this.Fields[17])).WriteChildren(writer);
            ((BlockField<ShaderStateMiscStateBlock>)(this.Fields[18])).WriteChildren(writer);
            ((BlockField<ShaderStateConstantBlock>)(this.Fields[19])).WriteChildren(writer);
        }
    }
}
