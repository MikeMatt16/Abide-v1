...
namespace Abide.Tag.Generated
{
    ...
    public sealed class ScenarioMachineStructV3Block : Block
    {
        ...
        /// <summary>
        /// Writes the scenario_machine_struct_v3_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the scenario_machine_struct_v3_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<PathfindingObjectIndexListBlock>)(this.Fields[1])).WriteChildren(writer);
        }
    }
}
