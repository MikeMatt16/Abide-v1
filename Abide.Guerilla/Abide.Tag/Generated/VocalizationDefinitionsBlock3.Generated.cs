...
namespace Abide.Tag.Generated
{
    ...
    /// <summary>
    /// Represents the generated vocalization_definitions_block_3 tag block.
    /// </summary>
    public sealed class VocalizationDefinitionsBlock3 : Block
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VocalizationDefinitionsBlock3"/> class.
        /// </summary>
        public VocalizationDefinitionsBlock3()
        {
            ...
            this.Fields.Add(new BlockField<VocalizationDefinitionsBlock4>("children", 500));
        }
        /// <summary>
        /// Gets and returns the name of the vocalization_definitions_block_3 tag block.
        /// </summary>
        public override string Name
        {
            get
            {
                return "vocalization_definitions_block_3";
            }
        }
        /// <summary>
        /// Gets and returns the display name of the vocalization_definitions_block_3 tag block.
        /// </summary>
        ...
        /// <summary>
        /// Gets and returns the maximum number of elements allowed of the vocalization_definitions_block_3 tag block.
        /// </summary>
        ...
        /// <summary>
        /// Gets and returns the alignment of the vocalization_definitions_block_3 tag block.
        /// </summary>
        ...
        /// <summary>
        /// Writes the vocalization_definitions_block_3 tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the vocalization_definitions_block_3 tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            ...
            ((BlockField<VocalizationDefinitionsBlock4>)(this.Fields[26])).WriteChildren(writer);
        }
    }
}
