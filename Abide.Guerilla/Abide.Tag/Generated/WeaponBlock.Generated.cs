...
namespace Abide.Tag.Generated
{
    ...
    public sealed class WeaponBlock : Block
    {
        ...
        public WeaponBlock()
        {
            this.Fields.Add(new ExplanationField("$$$ WEAPON $$$", null));
            ...
            this.Fields.Add(new ExplanationField("old obsolete export to functions", null));
            this.Fields.Add(new RealField("ready time:seconds"));
            this.Fields.Add(new TagReferenceField("ready effect"));
            this.Fields.Add(new TagReferenceField("ready damage effect"));
            this.Fields.Add(new ExplanationField("heat", null));
            ...
            this.Fields.Add(new TagReferenceField("overheated damage effect"));
            this.Fields.Add(new TagReferenceField("detonation"));
            this.Fields.Add(new TagReferenceField("detonation damage effect"));
            this.Fields.Add(new TagReferenceField("player melee damage"));
            this.Fields.Add(new TagReferenceField("player melee response"));
            this.Fields.Add(new ExplanationField("melee aim assist", null));
            this.Fields.Add(new StructField<MeleeAimAssistStructBlock>("melee aim assist"));
            this.Fields.Add(new ExplanationField("melee damage parameters", null));
            ...
            this.Fields.Add(new ExplanationField("zoom", null));
            ...
            this.Fields.Add(new ExplanationField("weapon aim assist", null));
            this.Fields.Add(new StructField<AimAssistStructBlock>("weapon aim assist"));
            this.Fields.Add(new ExplanationField("movement", null));
            ...
            this.Fields.Add(new ExplanationField("AI targeting parameters", null));
            ...
            this.Fields.Add(new TagReferenceField("zoom-in sound"));
            this.Fields.Add(new TagReferenceField("zoom-out sound"));
            ...
            this.Fields.Add(new ExplanationField("weapon labels", null));
            ...
            this.Fields.Add(new ExplanationField("more miscellaneous", null));
            ...
            this.Fields.Add(new ExplanationField("first-person movement control", null));
            ...
            this.Fields.Add(new TagReferenceField("deployed vehicle"));
            this.Fields.Add(new TagReferenceField("age effect"));
            this.Fields.Add(new TagReferenceField("aged weapon"));
        ...
        /// <summary>
        /// Writes the weapon_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the weapon_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<PredictedResourceBlock>)(this.Fields[65])).WriteChildren(writer);
            ((BlockField<Magazines>)(this.Fields[66])).WriteChildren(writer);
            ((BlockField<WeaponTriggers>)(this.Fields[67])).WriteChildren(writer);
            ((BlockField<WeaponBarrels>)(this.Fields[68])).WriteChildren(writer);
        }
    }
}
