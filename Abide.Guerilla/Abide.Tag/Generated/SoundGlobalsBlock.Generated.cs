...
namespace Abide.Tag.Generated
{
    ...
    public sealed class SoundGlobalsBlock : Block
    {
        ...
        {
            this.Fields.Add(new TagReferenceField("sound classes"));
            this.Fields.Add(new TagReferenceField("sound effects"));
            this.Fields.Add(new TagReferenceField("sound mix"));
            this.Fields.Add(new TagReferenceField("sound combat dialogue constants"));
