...
namespace Abide.Tag.Generated
{
    ...
    public sealed class LiquidCoreBlock : Block
    {
        ...
        public LiquidCoreBlock()
        {
            ...
            this.Fields.Add(new ExplanationField("THICKNESS", null));
            ...
            this.Fields.Add(new ExplanationField("BRIGHTNESS/TIME", null));
            this.Fields.Add(new StructField<ScalarFunctionStructBlock>("brightness-time"));
            this.Fields.Add(new ExplanationField("BRIGHTNESS/FACING", null));
