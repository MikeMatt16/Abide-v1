...
namespace Abide.Tag.Generated
{
    ...
    public sealed class CellularAutomata2dBlock : Block
    {
        ...
        {
            this.Fields.Add(new ExplanationField("properties", null));
            ...
            this.Fields.Add(new ExplanationField("height map", null));
            ...
            this.Fields.Add(new ExplanationField("detail map", null));
            this.Fields.Add(new ShortIntegerField("width:cells"));
            this.Fields.Add(new ShortIntegerField("height:cells"));
            this.Fields.Add(new RealField("cell width:world units"));
            this.Fields.Add(new RealVector2dField("velocity:cells/update"));
            ...
            this.Fields.Add(new PadField("", 2));
            this.Fields.Add(new PadField("", 48));
            this.Fields.Add(new TagReferenceField("texture"));
        ...
        /// <summary>
        /// Writes the cellular_automata2d_block tag block using the specified binary writer.
        /// </summary>
        // <param name="writer">The <see cref="BinaryWriter"/> used to write the cellular_automata2d_block tag block.</param>
        public override void Write(BinaryWriter writer)
        {
            // Invoke base write procedure.
            base.Write(writer);
            // Post-write the tag blocks.
            ((BlockField<RulesBlock>)(this.Fields[30])).WriteChildren(writer);
        }
    }
}
