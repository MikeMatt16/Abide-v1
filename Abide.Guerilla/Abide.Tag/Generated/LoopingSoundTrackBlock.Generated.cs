...
namespace Abide.Tag.Generated
{
    ...
    public sealed class LoopingSoundTrackBlock : Block
    {
        ...
        public LoopingSoundTrackBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("in"));
            this.Fields.Add(new TagReferenceField("loop"));
            this.Fields.Add(new TagReferenceField("out"));
            this.Fields.Add(new TagReferenceField("alt loop"));
            this.Fields.Add(new TagReferenceField("alt out"));
            this.Fields.Add(new EnumField("output effect", "none", "output front speakers", "output rear speakers", "output center speakers"));
            this.Fields.Add(new PadField("", 2));
            this.Fields.Add(new TagReferenceField("alt trans in"));
            this.Fields.Add(new TagReferenceField("alt trans out"));
