...
namespace Abide.Tag.Generated
{
    ...
    public sealed class CellularAutomataBlock : Block
    {
        ...
        {
            this.Fields.Add(new ExplanationField("parameters", null));
            ...
            this.Fields.Add(new ExplanationField("cell birth", null));
            this.Fields.Add(new RealFractionField("cell birth chance:[0,1]"));
            this.Fields.Add(new PadField("", 32));
            this.Fields.Add(new ExplanationField("gene mutation", null));
            ...
            this.Fields.Add(new PadField("", 32));
            this.Fields.Add(new ExplanationField("cell infection", null));
            ...
            this.Fields.Add(new PadField("", 32));
            this.Fields.Add(new ExplanationField("initial state", null));
            ...
            this.Fields.Add(new PadField("", 32));
            this.Fields.Add(new ExplanationField("detail texture", null));
            ...
            this.Fields.Add(new PadField("", 2));
            this.Fields.Add(new TagReferenceField("detail texture"));
            this.Fields.Add(new ExplanationField("mask texture", null));
            this.Fields.Add(new PadField("", 32));
            this.Fields.Add(new TagReferenceField("mask bitmap"));
