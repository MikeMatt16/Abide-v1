...
namespace Abide.Tag.Cache.Generated
{
    ...
    public sealed class ProjectileBlock : Block
    {
        ...
        public ProjectileBlock()
        {
            ...
            this.Fields.Add(new TagReferenceField("detonation started", "effe"));
            this.Fields.Add(new TagReferenceField("detonation effect (airborne)", "effe"));
            this.Fields.Add(new TagReferenceField("detonation effect (ground)", "effe"));
            this.Fields.Add(new TagReferenceField("detonation damage", "jpt!"));
            this.Fields.Add(new TagReferenceField("attached detonation damage", "jpt!"));
            this.Fields.Add(new TagReferenceField("super detonation", "effe"));
            this.Fields.Add(new StructField<SuperDetonationDamageStructBlock>("your momma!"));
            this.Fields.Add(new TagReferenceField("detonation sound", "snd!"));
            ...
            this.Fields.Add(new TagReferenceField("super attached detonation damage", "jpt!"));
            ...
            this.Fields.Add(new TagReferenceField("flyby sound", "snd!"));
            this.Fields.Add(new TagReferenceField("impact effect", "effe"));
            ...
            this.Fields.Add(new TagReferenceField("boarding detonation damage", "jpt!"));
            this.Fields.Add(new TagReferenceField("boarding attached detonation damage", "jpt!"));
